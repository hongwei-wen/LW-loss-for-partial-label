...
def prepare_cv_datasets(dataname, batch_size):
    if dataname == 'mnist':
        ordinary_train_dataset = dsets.MNIST(root='~/datasets/classification',
                                             ...
                                             download=False)
        test_dataset = dsets.MNIST(root='~/datasets/classification',
                                   train=False,
                                   transform=transforms.ToTensor())
        ...
        ordinary_train_dataset = dsets.KMNIST(root='~/datasets/classification',
                                              ...
                                              transform=transforms.ToTensor(),
                                              download=False)
        test_dataset = dsets.KMNIST(root='~/datasets/classification',
                                    train=False,
                                    transform=transforms.ToTensor())
        ...
        ordinary_train_dataset = dsets.FashionMNIST(
            ...
            transform=transforms.ToTensor(),
            download=False)
        test_dataset = dsets.FashionMNIST(root='~/datasets/classification',
                                          train=False,
                                          transform=transforms.ToTensor())
        ...
        ordinary_train_dataset = dsets.CIFAR10(
            ...
            download=False)
        test_dataset = dsets.CIFAR10(root='~/datasets/classification',
                                     train=False,
...
def prepare_cv_datasets_hyper(dataname, batch_size):
    if dataname == 'mnist':
        ...
        ordinary_train_dataset = dsets.CIFAR10(root='~/datasets/classification',
                                               train=True,
                                               transform=train_transform,
                                               download=True)
